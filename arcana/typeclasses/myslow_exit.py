...
MOVE_DELAY = {"freeze": 20,
              "stroll": 6,
              "walk": 4,
              "run": 2,
              "sprint": 1}

class mySlowExit(DefaultExit):
    """
    ...
    def at_traverse(self, traversing_object, target_location):
        ...
        if(move_speed == "freeze"):
            traversing_object.msg("You begin to move, but time is passing very slowly.")
        else:
